...
export const UpgradeButton: React.FC<UpgradeButtonProps> = ({ onClick }) => {
  return (
    <button
      onClick={onClick}
      className="fixed bottom-24 right-6 z-50 flex items-center px-6 py-3 bg-luxury-gold text-black font-black rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 animate-pulse-gold border border-luxury-gold/50
